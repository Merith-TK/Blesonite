...
BLESONITE_BLENDER_PATH:=$(call PROMPT,If you want to install Blender into a different directory than \`$(BLESONITE_BLENDER_PATH_DEFAULT)\`\, drag and drop or paste a preferably empty folder into the terminal, otherwise just press ENTER:)
